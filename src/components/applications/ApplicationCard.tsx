      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <h3 className="text-base font-semibold text-navy-500 truncate">
            ...
            {application.video_url && (
              <Video className="h-4 w-4 text-navy-500 shrink-0" />
            )}
          </div>
          ...
          {(application.athlete_level || application.athlete_age) && (
            <p className="mt-1 text-sm text-steel-600">
              <Zap className="mr-1 inline h-3.5 w-3.5 text-navy-500" />
          ...
          {/* Meta row */}
          <div className="mt-2 flex items-center gap-3 text-xs text-steel-400">
        ...
        <ChevronRight className="mt-1 h-5 w-5 shrink-0 text-steel-300" />
      </div>
    </button>
  )
}
